...
export function Projects() {
    return (
        <div id="projects" className="text-white text-center flex flex-col gap-y-16 py-16 px-2 rounded-lg bg-[#202020] shadow-[0_0_20px_rgba(255,255,255,0.2)]">
